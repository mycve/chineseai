...
fn build_async_training_report(
    ...
    AzLoopReport {
        ...
        terminal_repetition_quiet: pending.selfplay.terminal.repetition_quiet,
        terminal_repetition_current_check: pending.selfplay.terminal.repetition_current_check,
        terminal_repetition_current_chase: pending.selfplay.terminal.repetition_current_chase,
        terminal_repetition_rule_pressure: pending.selfplay.terminal.repetition_rule_pressure,
    ...
    match cli.command {
        ...
        Some(CliCommand::AzLoop(cmd)) => {
            ...
            loop {
                        ...
                        Err(mpsc::RecvTimeoutError::Timeout) => {
                            if interrupted.load(Ordering::SeqCst) {
                                ...
                                break AzLoopReport {
                                    ...
                                    terminal_repetition_quiet: 0,
                                    terminal_repetition_current_check: 0,
                                    terminal_repetition_current_chase: 0,
                                    terminal_repetition_rule_pressure: 0,
                ...
                println!(
                    "update {update:04}: games={} samples={} train_samples={} pool={}/{} fill={:.0}% R/B/D={}/{}/{} red_rate={:.3} avg_plies={:.1} loss={:.4} value_mse={:.4} v_mu={:.3}/{:.3} policy_ce={:.4} lr={:.6} tempH={:.3}/{:.3} term=N{} NA{} H120{} Rep{}(Q{} C{} Ch{} P{}) MLC{} MLCs{} Rw{} Bw{} Max{} selfplay={:.1}s train={:.1}s gps={:.2} sps={:.1} train_sps={:.1} elapsed={:.1}s{}",
                    report.games,
                    report.samples,
                    ...
                    report.terminal_repetition_quiet,
                    report.terminal_repetition_current_check,
                    report.terminal_repetition_current_chase,
                    report.terminal_repetition_rule_pressure,
