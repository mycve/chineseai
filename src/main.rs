...
fn az_model_parameter_count(model: &AzModel) -> usize {
    model.board_conv1_weights.len()
        ...
        + model.board_bn_scale.len()
        + model.board_bn_bias.len()
        + model.board_bn_running_mean.len()
        + model.board_bn_running_var.len()
        + model.residual_bn_scale.len()
        + model.residual_bn_bias.len()
        + model.residual_bn_running_mean.len()
        + model.residual_bn_running_var.len()
        ...
        + model.value_tail_bn_scale.len()
        + model.value_tail_bn_bias.len()
        + model.value_tail_bn_running_mean.len()
        + model.value_tail_bn_running_var.len()
        ...
        + model.policy_tail_bn_scale.len()
        + model.policy_tail_bn_bias.len()
        + model.policy_tail_bn_running_mean.len()
        + model.policy_tail_bn_running_var.len()
