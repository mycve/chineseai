...
pub struct AzLoopConfig {
    ...
    /// Per-root probability of independently scouting a ply in the configured
    /// mid/end-game range, independent of root policy concentration.
...
pub struct AzLoopReport {
    ...
    pub branch_endgame_repair: AzEndgameRepairReport,
...
pub struct AzEndgameRepairReport {
    ...
    pub rejected_low_advantage_rate: f32,
    pub verify_avg_candidates: f32,
}
