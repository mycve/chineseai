...
pub struct AzLoopReport {
    ...
    pub raw_top1_regret: f32,
    pub raw_policy_regret: f32,
    pub raw_top1_blunder_005: f32,
    pub raw_top1_blunder_010: f32,
    pub raw_top1_blunder_020: f32,
    pub blind_spot_forced_game_rate: f32,
