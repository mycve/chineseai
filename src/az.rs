...
use model::{
    ...
    LINE_CONTEXT_SCALE, PIECE_BOARD_CHANNELS, POLICY_CONDITION_SIZE, RESIDUAL_BLOCKS,
    VALUE_HEAD_CHANNELS, VALUE_HEAD_FEATURES, VALUE_HEAD_LEAK, VALUE_HEAD_MAP_SIZE,
    VALUE_HIDDEN_SIZE, VALUE_LOGIT_SCALE, VALUE_LOGITS, VALUE_SCALE_CP, dense_move_index,
    extract_board_planes, policy_move_features, policy_move_from_select, policy_move_to_select,
};
